...
export function ReviewCard() {
  return (
    <div className="flex items-center justify-center gap-4">
      <GameThumbnail className="hidden rounded-md transition-all min-[410px]:block" />
       ...
       */}
        <h2 className="mb-1 w-full truncate border-b-[1px] border-zinc-800 pb-1 font-bold text-white min-[410px]:hidden">
          Favorite Worst Nightmare
        </h2>
        <RatingProfileWidget username="galupd" rating={3} />
        <div className="my-2 h-[1px] w-full bg-zinc-800" />
        <blockquote>
          <p className="line-clamp-2 text-sm text-white min-[410px]:line-clamp-4">
